...
class GameState():
    ...
    def intro_game_draw(self):
        ...
        intro_game_text_render = intro_game_text.render('Stars', False, (255, 255, 255))
    ...
    def restart_game_draw(self):
        ...
        restart_game_text_render = restart_game_text.render('Retry', False, (255, 255, 255))
...
pygame.time.set_timer(star_timer, 100, -1)
pygame.time.set_timer(planet_timer, 5, -1)
pygame.time.set_timer(asteroid_timer, 2, -1)
